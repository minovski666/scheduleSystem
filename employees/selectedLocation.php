            ...
            <table class="table table-striped table-dark">
                ...
                if ($_SESSION['position_id'] == '3') {
                    ...
                    if (empty($_GET['location_id'])) {
                        ...
                        $sql = "SELECT * FROM employees INNER JOIN locations ON employees.location_id = locations.location_id AND employees.location_id = '$value' ORDER BY employee_id DESC  ";

                    }
                } elseif ($_SESSION['position_id'] == '4') {
                    if (empty($_GET['location_id'])) {

                        $sql = "SELECT * FROM employees INNER JOIN locations ON employees.location_id = locations.location_id WHERE employees.region_id = '{$_SESSION['region_id']}' ORDER BY employee_id DESC  ";
